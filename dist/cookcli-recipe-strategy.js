...
class CookCliRecipeViewStrategy extends HTMLElement {
  ...
  static _summaryTab(recipe, config, stepCount) {
    ...
    if (recipe.image_url) content += `<img src='${recipe.image_url}' alt='image de la recette 2' style='width: 100%;aspect-ratio: 16 / 10;object-fit: cover;border-radius: 12px;margin-bottom: 8px;' />\n\n`;
